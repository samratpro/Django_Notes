...
## Step 3: Push from local in git repo
  ```
...
### Step 4: Generate SSH Keys To Connect between Server and Github
```
...
### Step 9: DataBase, Domain & CSRF Fix
...
### Step 10: Start Database operation
...
```
### Step 11: Ensure 8000 port from security section
```
>> if missing add there
```

### Step 12: Restart App check 
>> http://ap_address:8000/ and you can see the 

### Step 13: Mapping with Domain URL
```
