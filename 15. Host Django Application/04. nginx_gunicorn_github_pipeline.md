...
## Step 14: Create a symbolic link to enable the new server block
...
## Step 16: Connecting domain with Ngnix
...
## Step 17: Install SSL on vps with Let's Encrypt (Requires domain):
