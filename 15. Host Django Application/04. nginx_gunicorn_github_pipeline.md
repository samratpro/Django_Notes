...
>>> git --version
```
## Step 3: ufw configurations -- Uncomplicated Firewall (UFW) 
```
>>> sudo apt update
...
## Step 5: Push from local in git repo
  ```
  ...
  ```
## Step 6: Generate SSH Keys To Connect between Server and Github
```
